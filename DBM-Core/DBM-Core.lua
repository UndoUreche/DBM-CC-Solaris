...
DBM = {
	Revision = releaseDate(2026, 04, 13),
	DisplayVersion = "OS-864d8cebfa8c", -- the string that is shown as version
	ReleaseRevision = releaseDate(2026, 04, 13) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
}
