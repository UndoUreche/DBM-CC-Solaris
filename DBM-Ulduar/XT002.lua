...
mod:RegisterEventsInCombat(
	...
	"SPELL_AURA_APPLIED 62775 63018 65121 63024 64234 63849 64193",
...
local timerNextTympanicTantrum		= mod:NewNextTimer(60, 62776, nil, nil, nil, 2, nil, DBM_COMMON_L.HEALER_ICON, nil, 3) -- S3 FM Log review 2022/07/17 - " Tympanic Tantrum-62776-npc:33293 = pull:60.0/Stage 1/60.0, Stage 2/6.6, Stage 1/29.0, 35.9/64.9/71.5, 60.0, 60.0, 60.0, 60.1, 60.0", -- [1]
...
function mod:OnCombatStart(delay)
	...
	timerNextTympanicTantrum:Start(60-delay)
...
function mod:SPELL_CAST_START(args)
	if args.spellId == 62776 then					-- Tympanic Tantrum (aoe damage + daze)
		...
		timerNextTympanicTantrum:Schedule(12, 48)
	end
end
...
function mod:SPELL_AURA_APPLIED(args)
	...
	elseif spellId == 63849 then	-- Exposed Heart
		...
		timerNextTympanicTantrum:Unschedule()
		timerNextTympanicTantrum:Stop()
		
		timerNextTympanicTantrum:Start(25)
			
		timerHeart:Start()

	elseif spellId == 64193 then -- hardmode trigger
