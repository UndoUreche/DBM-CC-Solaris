...
local timerFearCD		= mod:NewNextTimer(35, 64386, nil, nil, nil, 4, nil, nil)
local timerSwarmCD		= mod:NewNextTimer(40, 64396, nil, nil, nil, 1, nil, nil)
local timerSonicCD		= mod:NewNextTimer(50, 64688, nil, nil, nil, 2, nil, DBM_COMMON_L.DEADLY_ICON) 
...
function mod:SPELL_CAST_START(args)
	if args:IsSpellID(64678, 64389) then -- Sentinel Blast
		...
		timerDefender:AddTime(5, self.vb.catLives)
...
function mod:SPELL_AURA_REMOVED_DOSE(args)
	...
	if not args:IsSpellID(64455) then 
		return 
	end
