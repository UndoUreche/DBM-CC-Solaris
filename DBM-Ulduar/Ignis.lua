...
local timerFlameJetsCooldown	= mod:NewCDTimer(25, 63472, nil, nil, nil, 2, nil, DBM_COMMON_L.IMPORTANT_ICON)
local timerActivateConstruct	= mod:NewCDCountTimer(30, 62488, nil, nil, nil, 1, nil, nil)
...
function mod:OnCombatStart(delay)
	...
	timerActivateConstruct:Start(self:IsDifficulty("normal10") and 40 or 30, self.vb.ConstructCount+1)
...
function mod:SPELL_AURA_APPLIED(args)
	...
	elseif args:IsSpellID(62382, 67114) and self:AntiSpam(5, 1) then
