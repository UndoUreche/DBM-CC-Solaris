...
--local timerFearCD	= mod:NewCDTimer(19+11, 31013, nil, nil, nil, 2)
...
--local timerFearCD		= mod:NewTimer(20, "TimerFearCD", 31013, nil, nil, 3)
local timerFearCD		= mod:NewCDSourceTimer(20, 31013, nil, nil, nil, 2, nil)

mod:AddRangeFrameOption(10+3, 32337, true)
