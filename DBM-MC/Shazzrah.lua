...
local timerCurseCD			= mod:NewCDTimer(22+1, 19713, nil, nil, nil, 3, nil, DBM_COMMON_L.CURSE_ICON)
local timerDeadenMagic		= mod:NewBuffActiveTimer(30, 19714, nil, false, 3, 5, nil, DBM_COMMON_L.MAGIC_ICON)
local timerGateCD			= mod:NewCDTimer(41.3+3.7, 23138, nil, "Tank", 2, 5, nil, DBM_COMMON_L.TANK_ICON)
