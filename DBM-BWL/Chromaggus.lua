...
--	timerBreathCD:Start(-delay, "Breath 2")
	prewarn_P2 = false;
	breathTrackerBool = false
end

function mod:SPELL_CAST_START(args)
	if args:IsSpellID(23308, 23309, 23310, 23311) or args:IsSpellID(23313, 23314, 23315, 23316) or args:IsSpellID(23187, 23189) then
		warnBreathSoon:Cancel()
		warnBreathSoon:Schedule(25)
		warnBreath:Show(args.spellName)
		timerBreath:Start(args.spellName)
		
		if(breathTrackerBool) then
			timerBreathCD:Start(30, "Breath 1")
		else
			timerBreathCD:Start(30, "Breath 2")
		end
		
		breathTrackerBool = not breathTrackerBool;
	end
end
