...
local not_putting_more_effort_into_this_shit;

function mod:OnCombatStart(delay)
	not_putting_more_effort_into_this_shit = true;
end
...
function mod:SPELL_SUMMON(args)
	...
	not_putting_more_effort_into_this_shit = not not_putting_more_effort_into_this_shit
end
